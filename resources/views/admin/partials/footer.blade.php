...
<!-- END QUICK NAV -->
<!--[if lt IE 9]>
<script src="{{asset('admin-panel/assets/global/plugins/respond.min.js')}}"></script>
<script src="{{asset('admin-panel/assets/global/plugins/excanvas.min.js')}}"></script>
<script src="{{asset('admin-panel/assets/global/plugins/ie8.fix.min.js')}}"></script>
<![endif]-->
<!-- BEGIN CORE PLUGINS -->
